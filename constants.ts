...
export const EXAMS_DATA: Exam[] = [
  { id: 'ldc_lgs', title: { ml: 'LDC / LGS (എൽ.ഡി.സി / എൽ.ജി.എസ്) 2026', en: 'LDC / LGS' }, description: { ml: 'പത്താം ക്ലാസ്സ് യോഗ്യതയുള്ള പ്രധാന പരീക്ഷകൾ.', en: 'Major exams for 10th level qualification.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Preliminary' },
  { id: 'plus_two_prelims', title: { ml: 'Plus Two Prelims (CPO / Excise)', en: 'Plus Two Level Prelims' }, description: { ml: 'സിവിൽ പോലീസ് ഓഫീസർ, എക്സൈസ് ഇൻസ്പെക്ടർ തുടങ്ങിയ പരീക്ഷകൾ.', en: 'CPO, Excise Inspector and related exams.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Preliminary' },
  { id: 'degree_prelims', title: { ml: 'Degree Level Exams (ഡിഗ്രി ലെവൽ)', en: 'Degree Level Exams' }, description: { ml: 'സെക്രട്ടേറിയറ്റ് അസിസ്റ്റന്റ് ഉൾപ്പെടെയുള്ള ബിരുദതല പരീക്ഷകൾ.', en: 'Exams including Secretariat Assistant.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Preliminary' },
  { id: 'veo_exam', title: { ml: 'VEO (വില്ലേജ് എക്സ്റ്റൻഷൻ ഓഫീസർ)', en: 'Village Extension Officer' }, description: { ml: 'ഗ്രാമവികസന വകുപ്പിലെ പ്രധാന പരീക്ഷ.', en: 'Key exam in Rural Development department.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Main' },
  { id: 'fireman_exam', title: { ml: 'Fireman / Firewoman (ഫയർമാൻ)', en: 'Fireman / Firewoman' }, description: { ml: 'ഫയർ ആന്റ് റെസ്ക്യൂ സർവീസിലെ പരീക്ഷകൾ.', en: 'Fire and Rescue services exams.' }, icon: React.createElement(ShieldCheckIcon, { className: "h-8 w-8" }), category: 'Special', level: 'Preliminary' },
  { id: 'lp_up_assistant_malayalam', title: { ml: 'LP/UP Assistant Malayalam Medium (എൽ.പി/യു.പി അസിസ്റ്റന്റ് മലയാളം മീഡിയം)', en: 'LP/UP Assistant (Malayalam Medium)' }, description: { ml: 'വിദ്യാഭ്യാസ വകുപ്പിലെ മലയാളം മീഡിയം അദ്ധ്യാപക തസ്തികകൾ.', en: 'Teaching posts in Education department (Malayalam Medium).' }, icon: React.createElement(AcademicCapIcon, { className: "h-8 w-8" }), category: 'Teachers', level: 'Main' },
  { id: 'staff_nurse', title: { ml: 'Staff Nurse Gr II (സ്റ്റാഫ് നഴ്സ്)', en: 'Staff Nurse Gr II' }, description: { ml: 'ആരോഗ്യ വകുപ്പിലെ നഴ്സിംഗ് തസ്തികകളിലേക്കുള്ള പരീക്ഷ.', en: 'Nursing post exams in Health Department.' }, icon: React.createElement(BeakerIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'kseb_sub_eng', title: { ml: 'KSEB Sub Engineer (സബ് എൻജിനീയർ)', en: 'KSEB Sub Engineer' }, description: { ml: 'കെ.എസ്.ഇ.ബി ഇലക്ട്രിക്കൽ വിഭാഗം പരീക്ഷകൾ.', en: 'KSEB Electrical Engineering exams.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'si_police_2026', title: { ml: 'SI Police (സബ് ഇൻസ്പെക്ടർ പോലീസ്) 2026', en: 'SI Police' }, description: { ml: 'സബ് ഇൻസ്പെക്ടർ ഓഫ് പോലീസ് (ട്രെയിനി) പരീക്ഷകൾ.', en: 'Sub Inspector of Police (Trainee) exams.' }, icon: React.createElement(ShieldCheckIcon, { className: "h-8 w-8" }), category: 'General', level: 'Prelims + Mains' },
  { id: 'cpo_exam_2026', title: { ml: 'Civil Police Officer (സിവിൽ പോലീസ് ഓഫീസർ)', en: 'CPO' }, description: { ml: 'പോലീസ് വകുപ്പിലെ സിവിൽ പോലീസ് ഓഫീസർ പരീക്ഷകൾ.', en: 'Civil Police Officer exams in Police Department.' }, icon: React.createElement(ShieldCheckIcon, { className: "h-8 w-8" }), category: 'General', level: 'Preliminary + Physical' },
  { id: 'assistant_engineer_civil', title: { ml: 'Assistant Engineer Civil (അസിസ്റ്റന്റ് എഞ്ചിനീയർ - സിവിൽ)', en: 'Assistant Engineer Civil' }, description: { ml: 'KSEB / PWD / Irrigation വകുപ്പുകളിലെ സിവിൽ അസിസ്റ്റന്റ് എഞ്ചിനീയർ പരീക്ഷ.', en: 'Assistant Engineer (Civil) in various departments.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Prelims + Mains' },
  { id: 'assistant_engineer_electrical', title: { ml: 'Assistant Engineer Electrical (അസിസ്റ്റന്റ് എഞ്ചിനീയർ - ഇലക്ട്രിക്കൽ)', en: 'Assistant Engineer Electrical' }, description: { ml: 'KSEB / Electrical വകുപ്പുകളിലെ ഇലക്ട്രിക്കൽ അസിസ്റ്റന്റ് എഞ്ചിനീയർ പരീക്ഷ.', en: 'Assistant Engineer (Electrical) in KSEB etc.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Prelims + Mains' },
  { id: 'assistant_engineer_mechanical', title: { ml: 'Assistant Engineer Mechanical (അസിസ്റ്റന്റ് എഞ്ചിനീയർ - മെക്കാനിക്കൽ)', en: 'Assistant Engineer Mechanical' }, description: { ml: 'വിവിധ വകുപ്പുകളിലെ മെക്കാനിക്കൽ അസിസ്റ്റന്റ് എഞ്ചിനീയർ പരീക്ഷ.', en: 'Assistant Engineer (Mechanical) posts.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Prelims + Mains' },
  { id: 'jphn_anm', title: { ml: 'Junior Public Health Nurse / ANM (ജെ.പി.എച്ച്.എൻ / എ.എൻ.എം)', en: 'Junior Public Health Nurse / ANM' }, description: { ml: 'ആരോഗ്യ വകുപ്പിലെ ജൂനിയർ പബ്ലിക് ഹെൽത്ത് നഴ്സ് / ANM പരീക്ഷകൾ.', en: 'JPHN / ANM exams in Health Services.' }, icon: React.createElement(BeakerIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'kseb_ae', title: { ml: 'KSEB Assistant Engineer (കെ.എസ്.ഇ.ബി അസിസ്റ്റന്റ് എഞ്ചിനീയർ)', en: 'KSEB Assistant Engineer' }, description: { ml: 'കെ.എസ്.ഇ.ബി ഇലക്ട്രിക്കൽ / സിവിൽ അസിസ്റ്റന്റ് എഞ്ചിനീയർ പരീക്ഷകൾ.', en: 'Assistant Engineer in Kerala State Electricity Board.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Prelims + Mains' },
  { id: 'kas_2026', title: { ml: 'KAS (കേരള അഡ്മിനിസ്ട്രേറ്റീവ് സർവീസ്)', en: 'KAS' }, description: { ml: 'KAS ഓഫീസർ (Junior Time Scale) പരീക്ഷകൾ.', en: 'Kerala Administrative Service exams.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Prelims + Mains' },
  { id: 'pharmacist_gr2', title: { ml: 'Pharmacist Gr II (ഫാർമസിസ്റ്റ്)', en: 'Pharmacist Gr II' }, description: { ml: 'ആരോഗ്യ / ഇൻഷുറൻസ് മെഡിക്കൽ സർവീസസിലെ ഫാർമസിസ്റ്റ് പരീക്ഷകൾ.', en: 'Pharmacist posts in Health / Insurance Medical Services.' }, icon: React.createElement(BeakerIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'beat_forest_officer', title: { ml: 'Beat Forest Officer (ബീറ്റ് ഫോറസ്റ്റ് ഓഫീസർ)', en: 'Beat Forest Officer' }, description: { ml: 'വന വകുപ്പിലെ ബീറ്റ് ഫോറസ്റ്റ് ഓഫീസർ പരീക്ഷകൾ.', en: 'Beat Forest Officer exams (frequent notifications).' }, icon: React.createElement(GlobeAltIcon, { className: "h-8 w-8" }), category: 'Special', level: 'Prelims + Physical' },
  { id: 'civil_excise_officer', title: { ml: 'Civil Excise Officer (സിവിൽ എക്സൈസ് ഓഫീസർ)', en: 'Civil Excise Officer' }, description: { ml: 'എക്സൈസ് വകുപ്പിലെ സിവിൽ എക്സൈസ് ഓഫീസർ പരീക്ഷകൾ.', en: 'Civil Excise Officer (Plus Two level).' }, icon: React.createElement(ShieldCheckIcon, { className: "h-8 w-8" }), category: 'General', level: 'Prelims + Physical' },
  ...
  { id: 'tradesman_civil', title: { ml: 'Tradesman Civil (ട്രേഡ്സ്മാൻ - സിവിൽ)', en: 'Tradesman Civil' }, description: { ml: 'ടെക്നിക്കൽ എഡ്യൂക്കേഷൻ / ITI-യിലെ സിവിൽ ട്രേഡ്സ്മാൻ പരീക്ഷ.', en: 'Tradesman (Civil) posts.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'tradesman_mechanical', title: { ml: 'Tradesman Mechanical (ട്രേഡ്സ്മാൻ - മെക്കാനിക്കൽ)', en: 'Tradesman Mechanical' }, description: { ml: 'മെക്കാനിക്കൽ ട്രേഡുകളിലുള്ള ട്രേഡ്സ്മാൻ പരീക്ഷ.', en: 'Tradesman (Mechanical/Fitter/Turner etc.).' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'tradesman_electrical', title: { ml: 'Tradesman Electrical (ട്രേഡ്സ്മാൻ - ഇലക്ട്രിക്കൽ)', en: 'Tradesman Electrical' }, description: { ml: 'ഇലക്ട്രിക്കൽ ട്രേഡുകളിലുള്ള ട്രേഡ്സ്മാൻ പരീക്ഷ.', en: 'Tradesman (Electrical) posts.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'tradesman_fitter', title: { ml: 'Tradesman Fitter (ട്രേഡ്സ്മാൻ - ഫിറ്റർ)', en: 'Tradesman Fitter' }, description: { ml: 'ഫിറ്റർ ട്രേഡിലുള്ള ജൂനിയർ ഇൻസ്ട്രക്ടർ / ട്രേഡ്സ്മാൻ പരീക്ഷ.', en: 'Fitter trade exams.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'tradesman_turner', title: { ml: 'Tradesman Turner (ട്രേഡ്സ്മാൻ - ടർണർ)', en: 'Tradesman Turner' }, description: { ml: 'ടർണർ ട്രേഡിലുള്ള പരീക്ഷകൾ.', en: 'Turner trade in ITI/Technical Education.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'tradesman_draughtsman_civil', title: { ml: 'Tradesman Draughtsman Civil (ട്രേഡ്സ്മാൻ - ഡ്രോട്ട്സ്മാൻ സിവിൽ)', en: 'Tradesman Draughtsman Civil' }, description: { ml: 'ഡ്രോട്ട്സ്മാൻ സിവിൽ ട്രേഡ് പരീക്ഷ.', en: 'Draughtsman Civil trade.' }, icon: React.createElement(Cog6ToothIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'blood_bank_tech', title: { ml: 'Blood Bank Technician (ബ്ലഡ് ബാങ്ക് ടെക്നീഷ്യൻ)', en: 'Blood Bank Technician' }, description: { ml: 'ആരോഗ്യ വകുപ്പിലെ ബ്ലഡ് ബാങ്ക് ടെക്നീഷ്യൻ പരീക്ഷകൾ.', en: 'Blood Bank Technician (NCA variants).' }, icon: React.createElement(BeakerIcon, { className: "h-8 w-8" }), category: 'Technical', level: 'Main' },
  { id: 'prof_assistant_library', title: { ml: 'Professional Assistant Gr II (Library) (പ്രൊഫഷണൽ അസിസ്റ്റന്റ് (ലൈബ്രറി))', en: 'Professional Assistant (Library)' }, description: { ml: 'യൂണിവേഴ്സിറ്റികളിലെ പ്രൊഫഷണൽ അസിസ്റ്റന്റ് (ലൈബ്രറി) പരീക്ഷകൾ.', en: 'Library posts in Universities.' }, icon: React.createElement(BookOpenIcon, { className: "h-8 w-8" }), category: 'General', level: 'Main' },
  ...
  { id: 'hsst_kannada', title: { ml: 'HSST Kannada (ഹയർ സെക്കൻഡറി സ്കൂൾ ടീച്ചർ - കന്നഡ)', en: 'HSST Kannada' }, description: { ml: 'ഹയർ സെക്കൻഡറി വിദ്യാഭ്യാസ വകുപ്പിലെ കന്നഡ വിഷയത്തിലുള്ള HSST പരീക്ഷ.', en: 'Higher Secondary School Teacher - Kannada.' }, icon: React.createElement(AcademicCapIcon, { className: "h-8 w-8" }), category: 'Teachers', level: 'Main' },
  ...
  { id: 'hsst_botany', title: { ml: 'HSST Botany (ഹയർ സെക്കൻഡറി സ്കൂൾ ടീച്ചർ - ബോട്ടണി)', en: 'HSST Botany' }, description: { ml: 'ഹയർ സെക്കൻഡറി വിദ്യാഭ്യാസ വകുപ്പിലെ ബോട്ടണി വിഷയത്തിലുള്ള HSST പരീക്ഷ.', en: 'Higher Secondary School Teacher - Botany.' }, icon: React.createElement(AcademicCapIcon, { className: "h-8 w-8" }), category: 'Teachers', level: 'Main' },
  ...
  { id: 'cultural_subjects_exam', title: { ml: 'Cultural Subjects (സാംസ്കാരിക വിഷയങ്ങൾ)', en: 'Cultural Subjects' }, description: { ml: 'കല, സാഹിത്യം, സംസ്കാരം, കായികം തുടങ്ങിയ വിഷയങ്ങളിലെ പരീക്ഷകൾ.', en: 'Exams on Arts, Literature, Culture, and Sports.' }, icon: React.createElement(SparklesIcon, { className: "h-8 w-8" }), category: 'Cultural Subjects', level: 'Main' }
];
...
export const SYLLABUS_STRUCTURE = {
  'GK / Current Affairs / History / Geography / Polity / Economy': [
    ...
    'Indian Economy & Kerala Economy', 'Indian Polity & Constitution', 'Indian Constitution & Politics',
    'Kerala Polity & Administration', 'Important Laws & Acts', 'Important National & International Events', 
    'National & International Events', 'National Events', 'Current Affairs & Renaissance', 
    'Environment & Forestry', 'Kerala Specific', 'Micro Economic Analysis', 'Rural Development Schemes',
    'Climatology'
  ],
  'Science / Technical / Engineering': [
    ...
    'Software Engineering', 'Computer Networks', 'Web Technologies', 'Cyber Laws & Ethics', 'Mathematical Methods'
  ],
  'Languages / Literature': [
    ...
    'Hindi Literature & Grammar', 'Kannada Literature', 'Arabic Literature',
    'Tamil Literature'
  ],
  'Cultural Subjects': [
    'Arts Literature Culture & Sports', 'Music Theory & History', 'Raga & Tala System', 'Sports Psychology', 'Health Education'
  ],
  ...
  'Specialized / Subject Specific': [
    ...
    'Foundations of Library and Information Science', 'Library Classification', 'Information Sources', 
    'Information Services', 'Library Basics', 'Nursing Science / Health Care'
  ]
};
